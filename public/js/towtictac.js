//stores player turns
      ...
      document.getElementById("reset").addEventListener("click", function() {
        for (let i = 0; i < boxes.length; i++) {
          boxes[i].innerHTML = "";
          boxes[i].style.backgroundColor = "rgb(102, 178, 255)";
          boxes[i].style.color = "rgb(255, 255, 153)";
        }
        currentPlayer = "x";
        document.getElementById("message").innerHTML="Pick a Square!";
      ...
      function showWinner(x, y, z) {
        ...
        boxes[x].style.color = "rgb(255, 255, 153)";
        boxes[y].style.background = "#0d8b70";
        boxes[y].style.color = "rgb(255, 255, 153)";
        boxes[z].style.background = "#0d8b70";
        boxes[z].style.color = "rgb(255, 255, 153)";
        document.getElementById("message").innerHTML =
          currentPlayer == "x" ? "Player O Wins!" : "Player X Wins";
